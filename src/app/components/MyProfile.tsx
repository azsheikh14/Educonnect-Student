...
const MyProfile: React.FC<ProfileComponentProps> = ({ student }) => {
    return (
        <div className=' mx-4 h-full p-6 bg-white border border-gray-200 rounded-lg shadow-lg'>
            <div className='flex flex-col items-center mb-6 md:flex-row md:items-start'>
                {/* Profile Picture */}
                <div className='w-24 h-24 rounded-full border-4 border-blue-500 shadow-lg flex items-center justify-center overflow-hidden mb-4 md:mb-0 md:mr-6'>
                    <img
                ...
                <div className='text-center md:text-left ml-0 md:ml-3 md:mt-2'>
